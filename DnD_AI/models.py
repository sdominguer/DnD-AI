...
from .repositories import WeaponRepository, IWeaponRepository
from .default import *
...
class Weapon(models.Model):
    ...
    weapon_type = models.CharField(max_length=15, default="Body part")
    ...
    range_level_points = models.IntegerField(default=0)
    durability = models.IntegerField(default=100)
    level = models.IntegerField(default=0)

    # Instance of repository to abstract database operations
    weapon_repository: IWeaponRepository = WeaponRepository()
    ...
    def save(self, *args, **kwargs):
        """ Override save method to use repository """
        self.weapon_repository.save_weapon(self)
